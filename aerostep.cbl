       ...
       *> Buffers for UI optimization
       ...
       UPDATE-UI-ROW.
           IF UI-LINE > 0
               ...
               *> Bolt Optimization: Use pointers to track length, avoiding INITIALIZE and TRIM overhead
               ...
               *> Layout: Absolute positioning used within string to maintain grid
               ...
               STRING WS-ESC "[" UI-LINE ";3H"          *> Position: Name (Col 3)
                      ...
                      WITH POINTER WS-UI-PTR

               DISPLAY WS-UI-ROW-BUFFER(1:WS-UI-PTR - 1) WITH NO ADVANCING
